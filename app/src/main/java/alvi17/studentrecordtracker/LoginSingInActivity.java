...
public class LoginSingInActivity extends BaseActivity implements
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_login_signin);
...
public void onComplete(@NonNull Task<AuthResult> task) {
        ...
        Toast.makeText(LoginSingInActivity.this, "Authentication failed.",
